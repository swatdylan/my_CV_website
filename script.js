    ...
    function initCharts() {
            ...
            new Chart(returnCtx.getContext('2d'), {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [8.22, 12.30, 18.14, 20.44, 23.73, 26.58, 26.68, 28.78, 30.21, 32.03, 30.84, 30.88, 35.10, 42.50, 45.71],
        ...
        if (tableBody) {
            const perfData = [
                ...
                { m: "May '25", p: "+3.84%", c: "+5.77%" },
                { m: "Jun '25", p: "+3.40%", c: "+9.37%" },
                { m: "Jul '25", p: "+1.82%", c: "+11.36%" },
                { m: "Aug '25", p: "+2.90%", c: "+14.59%" },
                { m: "Sep '25", p: "+3.46%", c: "+18.56%" },
                { m: "Oct '25", p: "+4.72%", c: "+24.15%" },
                { m: "Nov '25", p: "+4.47%", c: "+29.70%" },
